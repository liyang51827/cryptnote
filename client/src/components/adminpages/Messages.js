...
const Messages = ({ path, getMessages, messages }) => {

  useEffectOnce(() => {
    console.log(' messages: useEffect : getMessages() ')
    getMessages();
  });
  ...
  // Avoid a layout jump when reaching the last page with empty messages.
  const emptyRows =
                      ...
                      .map((row, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell align="right">{row.createdAt.slice(0, 10) + ' ' + row.createdAt.slice(11, 19)}</TableCell>
                            <TableCell align="right">{row.expiredIn}</TableCell>
